...
<main class="main-container">
    ...
    @include('frontend.content.partial.slidephoto')

    </section>

    <!-- Shop Filter
    ============================================= -->
    @include('frontend.content.partial.category')
    @include('frontend.content.partial.bestsell')
{{--    @include('frontend.content.partial.recommend')--}}
    @include('frontend.content.partial.agent')
    @include('frontend.content.partial.newcustomer')
